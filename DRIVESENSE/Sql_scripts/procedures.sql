...
--using the above procedure
CALL AddServiceRecord(1500, 'Full Service', '2025-10-30', 54000, 'Routine checkup', 1, 'KA05MN1234');

--Procedure: Replace a Part for a Service Task
...
--Procedure: Get Service Summary of a Vehicle
...
--using the above procedureCALL GetVehicleServiceSummary('KA05MN1234');
